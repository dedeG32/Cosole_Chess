...
def guide():
    print('\nA simple chess game requiring 2 players.\n\n'
          'Pieces are formatted in a way the color is the first letter and the '
          'piece is the second. For exemple: black king = "bK".\n'
          'The second letter represent the piece. Below are all the pieces:'
          '\nKing = K\nQueen = Q\nKnight = N\nBishop = B\nRook = R'
          '\n\nTo move a piece you need to first indicate it position '
          '(letter followed by a number. Exemple: e5). Followed by a space. '
          'And then the case you want it to go.'
